...
save_path=outputs/dream_${dataset_name}_${time_reweighting}_use_focal_${use_focal_loss}_noise_dist_${noise_dist}_cpt_baseline_bs${BATCH_SIZE}_step${STEP}_${lr_scheduler}_lr${LR}
