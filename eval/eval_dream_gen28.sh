...
model=/data5/xyf/Dream/outputs/dream_transmla+math_linear_use_focal_false_noise_dist_Beta_enable_cutoff_false_cpt_adapt_bs1024_step2000_cosine_lr1e-5/global_step_2000
mask_free=True
