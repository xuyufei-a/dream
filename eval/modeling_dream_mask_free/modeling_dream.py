...
from .generation_utils import DreamGenerationMixin, DreamGenerationConfig, create_temporal_mask_wrapper
...
class MaskFreeDreamModel(DreamGenerationMixin, DreamPreTrainedModel):
    ...
    def forward(
        ...
        **loss_kwargs,
        ...
        if attention_mask is None:
            attention_mask = torch.ones_like(input_ids, device=input_ids.device, dtype=torch.float)
